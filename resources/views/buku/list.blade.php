...
<div class="container-fluid">
    ...
    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-4">
        ...
        <div class="col">
            <div class="card h-80 shadow-sm card-hover border-0">
                <div class="position-relative overflow-hidden rounded-top">
                    ...
                    @else
                        ...
                        <div class="card-img-top book-cover d-flex align-items-center justify-content-center bg-light text-muted">
                ...
                <div class="card-body d-flex flex-column pb-2">
                    ...
                    <h6 class="card-subtitle mb-3 text-muted small">
                        <i class="fa fa-user-edit me-1"></i> {{ $item->penulis }}
                    </h6>
...
<style>
    .book-cover {
height: 200px;        /* Tinggi saya naikkan sedikit agar lebih proporsional */
        width: 100%;
        object-fit: cover;    /* PERBAIKAN: Ganti contain jadi cover */
        object-position: center; /* Fokus ke tengah gambar */
        border-top-left-radius: 0.25rem; /* Opsional: Biar sudut atas melengkung ikut card */
