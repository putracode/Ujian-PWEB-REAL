                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('judul') is-invalid @enderror" id="judul"
                                name="judul" value="{{ old('judul', $buku->judul) }}" placeholder="Masukkan judul buku">
                            @error('judul')
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('tahun_terbit') is-invalid @enderror"
                                        ...
                                        value="{{ old('tahun_terbit', $buku->tahun_terbit) }}" placeholder="Contoh: 2025">
                                    @error('tahun_terbit')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            @if ($buku->cover_image)
                                <div class="mb-3">
                                    ...
                                    <img src="{{ asset('storage/' . $buku->cover_image) }}" alt="Current Cover"
                                        style="max-height: 150px; border-radius: 8px; border: 1px solid #ddd; padding: 5px;">
                                </div>
                            @endif

                            <small class="text-muted">Biarkan kosong jika tidak ingin mengubah gambar.</small>

                            <input type="file" class="filepond mt-2" name="cover_image" id="cover_image"
